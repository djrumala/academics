...
<body background="images/cityup.jpg" style="background-size:cover; opacity:0.9; background-repeat: no-repeat; background-attachment: fixed;">
	...
	<!--UI Web-->	
			...
			<div class="col l12 m12 s12" style="background-color:white; margin-top:-20px; background-color:rgba(255,255,255,0.5); margin-left:80px; margin-right:80px; padding:20px; 
				...
				<div class="col l12 m12 s12" style="margin-right:160px; font-size: 26px; font-family: 'Russo One'; color:#000; text-align:left;">FORMULIR RENCANA STUDI</div>
			...
			<div class="col l12 m12 s12" style="">
				<div class="row col l12" style="padding-right: 10px; padding-left: 10px; text-align: center; margin: 0px; color: white;">
					<div id="thead" class="col l3" style="padding: 12px;">Kode Materi</div>
					<div id="thead" class="col l7" style="padding: 12px;">Nama Materi</div>
			...
			<div class="col l12 m12 s12" style="padding-top:40px;">
				<div class="col l12 m6 s12">
					...
					<a  onClick="minus()" class="col l1 btn ts modal-trigger" style="margin:2px;">Drop</a>
	...
	function add(){ //tambah
		$('#add').show();
		$(document).ready(function(){
				$("#add").load("frsadd.php?"); //membuka tambah.php untuk menampilkan form kosong
		});
		$('#edit').hide();
		$('#minus').hide();
		$('#deleteall').hide();
	...
	function minus(){ //hapus
		$('#minus').show();
		$(document).ready(function(){
				$("#minus").load("frsdrop.php?sort="+srt+"&mark="+vup+"&pg="+page); //membuka minus.php untuk menampilkan form kosong
		});
		$('#add').hide();
		$('#edit').hide();
		$('#deleteall').hide();
	...
	function upclick(){
		...
		$(document).ready(function(){
				$("#data").load("frsisidata.php?sort="+srt+"&mark="+vup+"&pg="+page); //header nama diklik akan membuka data yang mengurutkan berdasar nama
		});
	}
	...
	var loadingdata = function(){
		$(document).ready(function(){
				$("#data").load("frsisidata.php?sort="+srt+"&mark="+vup+"&pg="+page); //membuka data.php untuk isi table
		});
		}
