				...
				if($b==$vup){
					echo "
						<div id='vdata' class='row col l12' style='padding-right: 10px; padding-left: 10px; margin: 0px; text-align: center; color: white;'>
							<div id='xdata' class='col l2' style='background-color:#33A1C9; border: 1px solid #ff0080; border-right:0px;'>".$kod."</div>
							<div id='xdata' class='col l6' style='background-color:#33A1C9; border: 1px solid #ff0080; border-left:0px; border-right:0px;'>".$dep['nmmatkul']."</div>
							...
							<div id='xdata' class='col l2' style='background-color:#33A1C9; border: 1px solid #ff0080; border-left:0px; border-right:0px;'>".$n."</div>
						</div>	
					";
				}
				else{
					echo "
						<div id='vdata' class='row col l12' style='padding-right: 10px; padding-left: 10px; margin: 0px; text-align: center; color: white;'>
							<div id='xdata' class='col l2'>".$dep['kdmatkul']."</div>
							<div id='xdata' class='col l6'>".$dep['nmmatkul']."</div>
